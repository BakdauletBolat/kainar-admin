...
**Статус:** В процессе
**Текущая фаза:** Фаза 10 завершена ✅ → Pages & App Layer готовы! → Фаза 11
...
| 9 | Pages | ✅ Готово | Средняя | - |
| 10 | App layer | ✅ Готово | Низкая | - |
...
- [x] Login page
- [x] Profile page
- [x] Parts pages (list, create, edit, detail)
- [x] Orders pages (list, in-progress, create, edit, detail)
- [x] Warehouses pages (list, create, edit, detail)
- [x] Clients pages (list, create, detail)
- [x] Feedbacks page (list)
- [x] Создана структура всех pages с FSD импортами
- [ ] Тестирование навигации (после исправления TS ошибок)
...
- [x] Создать app/providers/router.ts (с auth guard)
- [x] Создать app/providers/pinia.ts
- [x] Создать app/providers/ui.ts (Naive UI)
- [x] Создать app/styles/index.css
- [x] Создать app/index.ts (createApplication)
- [x] Создать app/App.vue (обновлен с FSD импортами)
- [x] Обновить main.ts (использует @app)
- [x] Обновить tsconfig.json (добавлен @app alias)
- [ ] Тестирование инициализации (после исправления TS ошибок)
- [ ] Коммит: "feat: FSD migration - Phase 9-10 (Pages & App Layer)"
...
- ✅ login (LoginPage)
- ✅ profile (ProfilePage)
- ✅ parts/* (list, create, edit, detail)
- ✅ orders/* (list, in-progress, create, edit, detail)
- ✅ warehouses/* (list, create, edit, detail)
- ✅ clients/* (list, create, detail)
- ✅ feedbacks/* (list)

#### App (100%) ✅
- ✅ providers (router, pinia, ui)
- ✅ styles (index.css)
- ✅ index (createApplication)
- ✅ App.vue (с FSD импортами)
...
| 2025-12-16 | 9-10 | Завершена миграция Pages (все страницы) и App Layer |
...
**Текущая фаза:** 10 завершена ✅ (App Layer - 100%)
**Следующий шаг:** Фаза 11 - Миграция импортов и исправление TypeScript ошибок
**Важная веха:** 🎉 ОСНОВНАЯ СТРУКТУРА FSD ГОТОВА! (Entities + Features + Widgets + Pages + App - 100%)

**Статус:**
- ✅ Все 11 entities мигрированы
- ✅ Все 17 features созданы
- ✅ Все 5 widgets готовы
- ✅ Все 20+ pages созданы в FSD структуре
- ✅ App layer с providers настроен
- ⚠️ ~50 TypeScript ошибок требуют исправления (несоответствие типов, отсутствующие методы)
