...
import { Modification, useModificationStore as useModificationsStore } from '@entities/modification'
import { useRoute, useRouter } from 'vue-router'
import { useColorStore } from '@entities/color'
import { setCurrent } from './index.ts'
...
function updateForm(item: Modification) {
