...
import WarehouseComponent from '@/pages/parts/ui/warehouse-component.vue'
...
const fetchProducts = async () => {
  ...
  await partStore.loadProducts({ warehouse: props.warehouseId, page_size: 100 })
  products.value = partStore.products
